        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($students as $student)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-500">{{ $student->created_at ? $student->created_at->format('Y-m-d') : 'N/A' }}</div>
                                        </td>
                    ...
                    @else
                        <p class="text-center py-4">No students found. <a href="{{ route('students.create') }}" class="text-indigo-600 hover:text-indigo-900">Add your first student</a>.</p>
                    @endif
                </div>
            </div>
        </div>
